...
/// Japanese help prose. Written for reviewers who are not IT specialists:
/// what the tool does, the 5-step workflow, task-based recipes, and a plain
/// glossary up front; the technical diagrams are folded away at the bottom.
